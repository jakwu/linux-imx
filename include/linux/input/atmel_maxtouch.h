...
#define	MXT224S_FAMILYID				0x82
#define MXT1386_FAMILYID                                0xA0

#define	MXT224_CAL_VARIANTID				0x01
#define	MXT224E_CAL_VARIANTID				0x01
#define	MXT224S_CAL_VARIANTID				0x24
...
#define	MXT_EXT_OBJECT_TABLE_ELEMENT_SIZE		 7
...
/* MXT_PROCG_NOISESUPPRESSION_T48 Message address definitions	*/
...
#define		MXT_MSGB_T48_STATCHG        0x10
#define		MXT_MSGB_T48_NLVLCHG        0x20
...
#define MXT_SET_THRESHOLD_IOCTL _IOW('x', 0x07, int)  /* Sets the touchscreen threshold */
#define MXT_SET_REPEAT _IOW('x', 0x08,int)
#define MXT_LOAD_SETTINGS _IO('x', 0x09)
#define MXT_PRINT_OBJECTS _IO('x', 0x0A)
...
// __OBSOLETE__, wgle, Apr 22, 2014	u8    (*valid_interrupt) (void);
// __OBSOLETE__, wgle, Apr 22, 2014	u8    (*read_chg) (void);
	u32   touch_gpio;
};
